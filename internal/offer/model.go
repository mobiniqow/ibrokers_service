...
type Offer struct {
    ...
    Initvolume str `json:"initVolume"`
    ...
    Offerring str `json:"offerRing"`
    Offersymbol str `json:"offerSymbol"`
    Securitytypenote str `json:"securityTypeNote"`
    Tradestatus str `json:"tradeStatus"`
}
